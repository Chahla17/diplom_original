...
class Item(models.Model):
    ...
    image2 = models.ImageField(default="default1.jpg")
...
class Item2(models.Model):
    ...
    characteristics = CKEditor5Field('Characteristics')
    image = models.ImageField(default="default1.jpg")
    category = models.ManyToManyField(Category, related_name='item2')

    def __str__(self):
        return self.title

    def get_absolute_url(self):
        return reverse('core:product2', kwargs={"slug": self.slug})
...
class Order(models.Model):
    ...
    dosatvka = models.CharField(max_length=100)
